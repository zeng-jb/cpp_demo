...
BEGIN_MESSAGE_MAP(CSaleSystemView, CView)
	...
	ON_COMMAND(ID_FILE_PRINT_PREVIEW, &CSaleSystemView::OnFilePrintPreview)
	ON_WM_CONTEXTMENU()
	ON_WM_RBUTTONUP()
END_MESSAGE_MAP()
...
void CSaleSystemView::OnFilePrintPreview()
{
#ifndef SHARED_HANDLERS
...
void CSaleSystemView::OnRButtonUp(UINT /* nFlags */, CPoint point)
{
	ClientToScreen(&point);
	OnContextMenu(this, point);
}

void CSaleSystemView::OnContextMenu(CWnd* /* pWnd */, CPoint point)
{
#ifndef SHARED_HANDLERS
